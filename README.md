...
Files are from 8 modeling centers [CMA, CMC, CPTEC, ECMF, JMA, KMA, NCEP, UKMO] the and the zarr path has the type All_Zarr/MJO_XXXXzar where XXXX represents the center (e.g. ./All_Zarr/MJO_ECMWFzar )
...
Files are from 8 modeling centers [CMA, CMC, CPTEC, ECMF, JMA, KMA, NCEP, UKMO] the and the zarr path has the type All_Zarr/PNA_XXXXzar where XXXX represents the center (e.g. ./All_Zarr/MJO_ECMWFzar )
...
Files are from the NCEP GFS model, and has 3 forecast lead times (006hr,048hr,168hr) the zarr path has the type All_Zarr/GFSIVT_FXXX_zarr where XXXX represents forecast lead (e.g. ./All_Zarr/GFSIVT_F048_zarr )
...
Files are from the ECMWF 51 member ensemble, and contains 048hr forecast's of T2m the zarr path has the type All_Zarr/ECMWFt2m_zar
...
Files are from the UKMO ensemble, and contains road temperature conditions in the UK the zarr path has the type All_Zarr/Hrly_RoadForecast_zarr
